...
const Card = ({ color, name, img, textColor, btnColor, status, followers }) => {
  return (
    <div
      className={`flex h-[300px] cursor-pointer flex-col items-center justify-evenly rounded-3xl
                 bg-gradient-to-t from-white ${color} p-4 shadow-[0_8px_30px_rgb(0,0,0,0.12)] 
